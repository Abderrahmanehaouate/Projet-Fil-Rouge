    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            <div class="flex-shrink-0 flex items-center">
                ...
                <x-application-logo class="hidden lg:block h-8 w-auto" />
            </div>
                ...
                @auth
                    ...
                    <div class="ml-3 relative">
                        <div>
                            ...
                            <img class="h-8 w-8 rounded-full" src="https://i.pravatar.cc/104?id={{ Auth::user()->name }}" alt="">
                            </button>
                        </div>
                        <div class="origin-top-right absolute hidden z-20 right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                            ...
                            <a href="{{ url('/dashboard') }}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Dashboard</a>
                    ...
                    @else
                        <div class="sm:ml-6 sm:flex sm:space-x-8">
                            <a href="{{ route('login') }}" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Log in</a>
        ...
        <div class="sm:hidden hidden" id="mobile-menu">
            <div class="pt-2 pb-4 space-y-1">
                ...
                <a href="#" class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">Donation</a>
                ...
                <a href="#" class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">Cantact us</a>
            </div>
        </div>
</nav>

<script>
    const buttonMenu = document.querySelector('[aria-controls="mobile-menu"]');
    const menuMobil = document.getElementById('mobile-menu');

    buttonMenu.addEventListener('click', () => {
    const expanded = buttonMenu.getAttribute('aria-expanded') === 'true';
    buttonMenu.setAttribute('aria-expanded', !expanded);
    menuMobil.classList.toggle('hidden');
    });
